...
public class geologyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_geology, container, false);
        ...
        textLoad.setOnClickListener(v -> {
            ...
            String url = "https://www.bncollegepatna.com/department_login/files/1568196764.pdf";
        ...
        imageList.add(new SlideModel(R.drawable.geolo_depart, ScaleTypes.CENTER_CROP));
        imageList.add(new SlideModel(R.drawable.geolo_depart1, ScaleTypes.CENTER_CROP));
        imageList.add(new SlideModel(R.drawable.geolo_depart2, ScaleTypes.CENTER_CROP));
