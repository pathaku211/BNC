...
public class political_scienceFragment extends Fragment {
    ...
    public political_scienceFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root= inflater.inflate(R.layout.fragment_political_science, container, false);
        ...
        textLoad.setOnClickListener(v -> {
            ...
            String url = "https://www.bncollegepatna.com/department_login/files/1584201371.pdf";
        ...
        imageList.add(new SlideModel(R.drawable.pol_depart, ScaleTypes.CENTER_CROP));
