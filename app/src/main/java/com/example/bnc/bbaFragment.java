...
public class bbaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_bba, container, false);
        ...
        textLoad.setOnClickListener(v -> {
            ...
            String url = "https://www.bncollegepatna.com/department_login/files/1633418038.pdf";
        ...
        imageList.add(new SlideModel(R.drawable.bba_depart, ScaleTypes.CENTER_CROP));
