...
public class chemistryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root= inflater.inflate(R.layout.fragment_chemistry, container, false);
        ...
        textLoad.setOnClickListener(v -> {
            ...
            String url = "https://www.bncollegepatna.com/department_login/files/1633419154.pdf";
        ...
        imageList.add(new SlideModel(R.drawable.bn_college4, ScaleTypes.CENTER_CROP));
