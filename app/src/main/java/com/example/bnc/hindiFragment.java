...
public class hindiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textLoad.setOnClickListener(v -> {
            ...
            String url = "https://www.bncollegepatna.com/department_login/files/1568354608.pdf";
        ...
        imageList.add(new SlideModel(R.drawable.hindi_depart, ScaleTypes.CENTER_CROP));
