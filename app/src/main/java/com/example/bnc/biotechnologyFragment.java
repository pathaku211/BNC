...
public class biotechnologyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_biotechnology, container, false);
        ...
        textLoad.setOnClickListener(v -> {
            ...
            String url = "https://www.bncollegepatna.com/department_login/files/1567849838.pdf";
        ...
        imageList.add(new SlideModel(R.drawable.biotech_depart, ScaleTypes.CENTER_CROP));
        imageList.add(new SlideModel(R.drawable.bn_college, ScaleTypes.CENTER_CROP));
        imageList.add(new SlideModel(R.drawable.biotech_depart1, ScaleTypes.CENTER_CROP));
