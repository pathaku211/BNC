...
public class bcaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root= inflater.inflate(R.layout.fragment_bca, container, false);
        ...
        imageList.add(new SlideModel(R.drawable.bca_depart, ScaleTypes.CENTER_CROP));
        imageList.add(new SlideModel(R.drawable.bn_college10, ScaleTypes.CENTER_CROP));
        ...
        textLoad.setOnClickListener(v -> {
            ...
            String url = "https://www.bncollegepatna.com/department_login/files/1587280176.pdf";
