...
public class geographyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_geography, container, false);
        ...
        textLoad.setOnClickListener(v -> {
            ...
            String url = "https://www.bncollegepatna.com/department_login/files/1564726701.pdf";
        ...
        imageList.add(new SlideModel(R.drawable.geo_depart, ScaleTypes.CENTER_CROP));
