...
public class sanskritFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageList.add(new SlideModel(R.drawable.sans_depart1, ScaleTypes.CENTER_CROP));
        imageList.add(new SlideModel(R.drawable.sans_depart2, ScaleTypes.CENTER_CROP));
