...
public class psychologyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageList.add(new SlideModel(R.drawable.psycho_depart, ScaleTypes.CENTER_CROP));
        imageList.add(new SlideModel(R.drawable.bn_college12, ScaleTypes.CENTER_CROP));
